...
class PicMitratelController extends Controller
{
    public function indexPic()
    {
        ...
        return view('Admin/Mitratel/buatPicMitratel', compact('units'));
    }

    public function indexUnit()
    {
        return view('Admin/Mitratel/buatUnitMitratel');
    }
    ...
    public function indexEditUnit($id)
    {
        ...
        return view('Admin/Mitratel/editUnitMitratel', compact('unit'));
    }
    ...
    public function indexEditPic($id)
    {
        ...
        return view('Admin/Mitratel/editPicMitratel', compact('units', 'pic'));
    }
    ...
    public function lihatPic()
    {
        ...
        return view('Admin/Mitratel/lihatPicMitratel', compact('picTas'));
    }
    ...
    public function lihatUnit()
    {
        ...
        return view('Admin/Mitratel/lihatUnitMitratel', compact('unitTas'));
    }
