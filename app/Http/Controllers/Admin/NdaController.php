...
class NdaController extends Controller
{
    public function indexPicTelkomAkses()
    {
        ...
        return view('Admin/TelkomAkses/lihatNdaPicTelkomAkses', compact('pics', 'arrayStatusNda', 'arrayMasaBerlakuNda'));
    }

    public function indexPicMitratel()
    {
        $pics = PicMitra::where([
            'idPerusahaan' => 5
        ])->get();
        ...
        return view('Admin/Mitratel/lihatNdaPicMitratel', compact('pics', 'arrayStatusNda', 'arrayMasaBerlakuNda'));
    }
    ...
    public function indexPicTkmNetra()
    {
        ...
        return view('Admin/TkmNetra/lihatNdaPicTkmNetra', compact('pics', 'arrayStatusNda', 'arrayMasaBerlakuNda'));
    }
    ...
    public function indexPicSigma()
    {
        ...
        return view('Admin/Sigma/lihatNdaPicSigma', compact('pics', 'arrayStatusNda', 'arrayMasaBerlakuNda'));
    }
    ...
    public function indexPicMitra()
    {
        ...
        return view('Admin/Mitra/lihatNdaPicMitra', compact('pics', 'arrayStatusNda', 'arrayMasaBerlakuNda'));
    }
    ...
    public function indexUploadNda($id)
    {
        ...
        return view('Admin/uploadNda', compact('pic'));
    }
    ...
    public function uploadNda(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'mimes' => ':Attribute gagal diunggah, lampiran harus berupa PDF/JPEG/PNG/JPG',
        ...
        if ($pic->idPerusahaan == 1) {
            return redirect()->route('get-lihatNdaMitra')
                ->with([
                    'status' => 'success',
            ...
            return redirect()->route('get-lihatNdaTelkomAkses')
                ->with([
                    'status' => 'success',
                    'message' => 'NDA Petugas ' . $pic->nama . ' Berhasil diunggah, Berlaku hingga ' . NdaController::formatTanggalIndo($ndaBaru->tanggalBerakhir) . ' !'
                ]);
        } elseif ($pic->idPerusahaan == 3) {
            return redirect()->route('get-lihatNdaSigma')
                ->with([
                    'status' => 'success',
                    'message' => 'NDA Petugas ' . $pic->nama . ' Berhasil diunggah, Berlaku hingga ' . NdaController::formatTanggalIndo($ndaBaru->tanggalBerakhir) . ' !'
                ]);
        } elseif ($pic->idPerusahaan == 4) {
            return redirect()->route('get-lihatNdaTkmNetra')
                ->with([
                    'status' => 'success',
                    'message' => 'NDA Petugas ' . $pic->nama . ' Berhasil diunggah, Berlaku hingga ' . NdaController::formatTanggalIndo($ndaBaru->tanggalBerakhir) . ' !'
                ]);
        } else {
            return redirect()->route('get-lihatNdaMitratel')
                ->with([
                    'status' => 'success',
                    'message' => 'NDA Petugas ' . $pic->nama . ' Berhasil diunggah, Berlaku hingga ' . NdaController::formatTanggalIndo($ndaBaru->tanggalBerakhir) . ' !'
                ]);
