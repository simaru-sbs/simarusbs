...
class beritaSimaruController extends Controller
{
    ...
    {
        return view('Validator/Berita/buatBerita');
    }
    ...
    public function indexEditBerita($id)
    {
        ...
        return view('Validator/Berita/editBerita', compact('berita'));
    }

    public function lihatBerita()
    {
        $beritas = BeritaSimaru::all();
        return view('Validator/Berita/lihatBerita', compact('beritas'));
    }
    ...
    public function editBerita(Request $request)
    {
        ...
        return redirect()->route('get-validatorLihatBerita')
            ->with([
                'status' => 'success',
