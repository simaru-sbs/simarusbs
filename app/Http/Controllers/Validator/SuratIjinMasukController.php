...
class SuratIjinMasukController extends Controller
{
    public function indexLihatSurat()
    {
        ...
        return view('Validator/lihatSuratMasuk', compact('surats'));
    }
    ...
    public function indexBuat()
    {
        ...
        return view('Validator/buatSuratMasuk', compact('picTelkoms', 'unitSigmas', 'unitTas', 'lokasis','jmlSurat','picTkmNetras'));
    }
    ...
    public function indexEditSurat($id)
    {
        ...
        return view('Validator/editSurat', compact('surat', 'tahun', 'angka', 'lokasis', 'picTelkoms', 'perusahaanPic', 'unitSigmas', 'unitTas', 'unitSurat','jmlSurat','picTkmNetras'));
    ...
    public function buatSurat(Request $request)
    {
        ...
        return redirect()->route('get-validatorBuatSuratMasuk')
            ->with([
                'status' => 'success',
    ...
    public function editSurat(Request $request)
    {
        ...
        if ($request->kategori == "telkomAkses") {
            if (!$request->unitTa) {
                return redirect()->route('get-validatorIndexEditSurat', ['id' => $request->id])
                    ->with([
                        'status' => 'warning',
                        'message' => 'SIMARU harus memiliki PIC Mitra!'
                    ]);
    ...
    public function validasiSurat($id)
    {
        ...
        if ($surat->statusSurat != 1 && $surat->validate2 == 0) {
            $surat->update([
                'statusSurat' => 1,
                'validate1' => 1
            ]);
    ...
    public function cetakSurat($id)
    {
        ...
        $tahun = substr($surat->nomorSurat, -4);
        $angka = str_replace($tahun, '', $surat->nomorSurat);
        return view('Validator/cetakSurat', compact('surat', 'angka', 'tahun', 'tanggal', 'tanggalMulai', 'tanggalBerakhir', 'arrayK1', 'arrayK2', 'arrayK3', 'arrayL1', 'arrayL2', 'arrayL3'));
    }
    ...
    public function detailSurat($id)
    {
        ...
        $tahun = substr($surat->nomorSurat, -4);
        $angka = str_replace($tahun, '', $surat->nomorSurat);
        return view('Validator/detailSurat', compact('surat', 'angka', 'tahun', 'tanggal', 'tanggalMulai', 'tanggalBerakhir', 'arrayK1', 'arrayK2', 'arrayK3', 'arrayL1', 'arrayL2', 'arrayL3'));
    }
