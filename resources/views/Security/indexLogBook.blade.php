...
@section('content-header')
    <h1>Index Log Book {{auth('user')->user()->lokasi->lokasi}}
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Index Log Book {{auth('user')->user()->lokasi->lokasi}}</h3>
                ...
                <form action="{{route('get-securityLihatLogBook')}}" class="form-horizontal" method="get">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-success pull-right" id="submit">Lihat Log Book</button>
