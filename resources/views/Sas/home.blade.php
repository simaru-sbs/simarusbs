...
@section('content-header')
    <h1>Dashboard MGR SAS SURABAYA SELATAN
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{route('sas-home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
    </ol>
@endsection
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-xs-12" style="padding: 0px 0px 0px 0px">
                                        <a href="{{route('get-sasDetailSurat',['id' => $surat->id])}}">
                                            <button type="submit"
