...
@section('content-header')
    ...
    <ol class="breadcrumb">
        <li><a href="{{route('admin-home')}}"><i class="fa fa-dashboard"></i> Home</a></li>    </ol>
@endsection
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 0px 7px 0px 12px">
                                            <a href="{{route('get-editPicMitra',['id' => $picMitra->id])}}">
                                                <button type="submit"
                                        ...
                                        <div class="col-xs-6" style="padding: 0px 12px 0px 7px">
                                            <a href="{{route('get-hapusPicMitra',['id' => $picMitra->id])}}')}}">
                                                <button type="submit"
