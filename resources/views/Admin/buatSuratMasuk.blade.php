...
@section('content')
    ...
    <form action="{{route('post-buatSuratMasuk')}}" role="form" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   class="form-control"
                                   name="kepada"
                                   placeholder="Nama Instansi PIC MITRA" required autocomplete="off"
                                   value="{{old('kepada')}}"
                            >
                        </div>
                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control chosen-select"
                                            ...
                                            @else
                                                @foreach($unitTas as $unitTa)
                                                    <option title=""
                                                            value="{{$unitTa->id}}">{{$unitTa->namaUnit}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
        ...
        $(function () {
            ...
            $('#addButton').on('click', function () {
                    ...
                    if (/^[0-9]*$/.test(jumlah) == false || jumlah == '') {
                        alert('Jumlah nama harus berupa angka positif!');
                    } else {
                        var jumlah = $('#jumlah').val()
                        for (i = 0; i < jumlah; i++) {
                            $('#tambah')
