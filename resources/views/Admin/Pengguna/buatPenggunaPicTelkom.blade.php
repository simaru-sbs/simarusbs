        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Pengguna PIC Telkom</h3>
                ...
                <form action="{{route('post-buatUserPicTelkom')}}" class="form-horizontal" method="POST">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control chosen" name="picTelkom" style="border-radius: 10px" required>
                                    @foreach($picTelkoms as $picTelkom)
                                        @if(old('picTelkom') == $picTelkom->id)
                                            <option title="" value="{{$picTelkom->id}}" selected>{{$picTelkom->nama}} ({{$picTelkom->unit}}) </option>
                                        @else
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-success pull-right" id="submit">Tambah Pengguna PIC Telkom</button>
                        <a href="{{route('admin-home')}}">
                            <button type="button" class="btn btn-warning pull-right" style="margin-right: 5px;" id="kembali">
                                Kembali
                            </button>
                        </a>
                    </div>
