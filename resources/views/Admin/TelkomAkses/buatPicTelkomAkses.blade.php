        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Form PIC Telkom Akses</h3>
                ...
                <form action="{{route('post-buatPicTelkomAkses')}}" class="form-horizontal" method="POST">
                    {{csrf_field()}}
                    <div class="box-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small>Pilih Salah Satu Unit Telkom Akses</small>
                            </div>
                        </div>
                    </div>

                    <div class="box-footer">
                        <button type="submit" class="btn btn-success pull-right" id="submit">Tambah PIC Telkom Akses</button>
    ...
    <script>
        $(function () {
            ...
            $('#submit').on('click', function () {
                ...
                return confirm('Buat Pic Telkom Akses?')
            });
        });
    </script>
@endsection