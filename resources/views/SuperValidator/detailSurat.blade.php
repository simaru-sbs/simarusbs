...
@section('content')
    ...
    <section class="invoice">
        ...
        <div class="row no-print">
            <div class="col-md-12">
                <a target="_blank" href="{{route('get-superValidatorCetakSurat',['id' => $surat->id])}}">
                    <button type="button" class="btn btn-primary pull-right" style="margin:3px 5px 3px 0px;">
                        <i class="fa fa-print"></i> Cetak Surat
                    </button>
                </a>
                <a target="_blank"
                   href="{{route('get-superValidatorLihatLampiran',['id' => ($surat->lampiran ? $surat->lampiran->pathUri : "null")])}}">
