        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Edit Unit PIC Sigma</h3>
                ...
                <form action="{{route('post-validatorEditUnitSigma',['id' => $unit->id])}}" class="form-horizontal"
                      method="POST">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                @if(old('namaUnit'))
                                    <input type="text" class="form-control" name="namaUnit"
                                           placeholder="Nama Perusahaan"
                                           value="{{old('namaUnit')}}" required autocomplete="off">
                                @else
                                    <input type="text" class="form-control" name="namaUnit"
                                           placeholder="Nama Perusahaan"
                                           value="{{$unit->namaUnit}}" required autocomplete="off">
                                @endif
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{route('get-validatorLihatUnitSigma')}}">
