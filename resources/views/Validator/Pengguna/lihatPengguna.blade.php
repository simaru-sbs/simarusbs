                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-4" style="padding: 0px 4px 0px 10px">
                                            <a href="{{route('get-validatorValidasiSecurity',['id' => $user->id])}}">
                                                <button type="submit"
                                                        class="btn btn-success pull-right btn-block btn-sm validasi" value="{{$user->nama}}"
                                        ...
                                        <div class="col-xs-4" style="padding: 0px 7px 0px 4px">
                                            <a href="{{route('get-validatorEditUser',['id' => $user->id])}}">
                                                <button type="submit"
                                        ...
                                        <div class="col-xs-4" style="padding: 0px 12px 0px 0px">
                                            <a href="{{route('get-validatorHapusUser',['id' => $user->id])}}')}}">
                                                <button type="submit"
