        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Data PIC Mitratel</h3>
                </div>
                <!-- /.box-header -->
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 0px 7px 0px 12px">
                                            <a href="{{route('get-validatorEditPicTelkomAkses',['id' => $picTa->id])}}">
                                                <button type="submit"
                                        ...
                                        <div class="col-xs-6" style="padding: 0px 12px 0px 7px">
                                            <a href="{{route('get-validatorHapusPicTelkomAkses',['id' => $picTa->id])}}')}}">
                                                <button type="submit"
