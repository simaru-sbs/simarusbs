    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-danger">
                ...
                <form action="{{route('post-validatorEditPicTelkomAkses',['id' => $pic->id])}}" class="form-horizontal"
                      method="POST">
                    {{csrf_field()}}
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{route('get-validatorLihatPicTelkomAkses')}}">
