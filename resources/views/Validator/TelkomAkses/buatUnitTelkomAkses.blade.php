        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Tambah Unit Telkom Akses</h3>
                ...
                <form action="{{route('post-validatorBuatUnitTelkomAkses')}}" class="form-horizontal" method="POST">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                @if(old('namaUnit'))
                                    <input type="text" class="form-control" name="namaUnit" placeholder="Nama Divisi"
    ...
    <script>
        $(function () {
            ...
            $('#submit').on('click', function () {
                return confirm('Buat Unit Telkom Akses?')
            });
        });
    </script>
@endsection